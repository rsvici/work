    ...
    var vc3dEye = function(selectorName, params) {
        ...
        function forceLoadAllImages() {
            ...
            $("<img/>").attr("src", appropriateImageUrl).load(function() {
                // selector.height($(window)[0].outerHeight).width($(window)[0].outerWidth);
            });
        ...
        function initializeOverlayDiv() {
            $("html").append("<style type='text/css'>.onLoadingDiv{opacity:0.5;text-align:center;font-size:2em;font:color:#000000;}</style>")
