...
$(document).scroll(function () {
  ...
  console.log(scroH);
  if (scroH > 10 && scroH < 600) {
    $('.jieshao').addClass('animated  zoomIn ');
    $('.jieshao_juanzhou').addClass('animated  zoomIn ');
    $('.jieshao_logo').addClass('animated  zoomIn ');
    $('.jieshao_juanzhou_word').addClass('animated  zoomIn');

  } else if (scroH > 600 && scroH < 1000) {
...
setTimeout(function () {
  $('.nav').children('li').removeClass('animated  zoomIn delay-0_5s');
}, 1500)
...
$('.nav').children('li').on('click', function () {
  ...
  $('.nav li  .navbgImg').removeClass('animated  zoomIn delay-0_5s');

  $(this).addClass('active').siblings('li').removeClass('active');

  $(this).children('.navbgImg').addClass('animated  zoomIn');
